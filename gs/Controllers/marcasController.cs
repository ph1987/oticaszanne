...
namespace gs.Controllers
{
    public class marcasController : Controller
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create(marcas consulta, HttpPostedFileBase file)
        {
            ...
            var ultimoitem = new marcas();
            var consultaOrdem = (from ev in db.marcas orderby ev.ordem ascending select ev).ToList();
        ...
        {
            var consulta = db.marcas.Single(a => a.id == id);
            /*
            try
            {
